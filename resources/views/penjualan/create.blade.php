...
<div class="tab-content" id="divpenjualan">
	<div class="tab-pane active" id="horizontal-form">
		<form class="form-horizontal" method="post" action="#">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<a href="#" class="btn btn-primary" id="tambahcustomer" style="width:100%;">
						TAMBAH CUSTOMER
					</a>
				</div>
			</div>
	...
	function addBarang(...args)
	{
		...
		else
		{
			...
			"<tr>" +
				...
				"<td><input type='number' class='form-control' placeholder='Harga Jual' required name='harga_" + barangs.length + "'></td>" +
